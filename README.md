...
🌸Videos: [Youtube Playlist](https://www.youtube.com/playlist?list=PLZGvAjHkhphA2DZsifSW5YBwPAJFSsBHV)
...
* Utilizar los componentes geográficos de las herramientas de modelación hidrológica HEC-HMS y de modelación hidráulica HEC-RAS, integradas a HEC-DSSvue mediante un proyecto aplicado a una cuenca y a un tramo de río a partir de un levantamiento topográfico digitalizado o el diseño previo de un río trazado en CAD e información obtenida a partir de imágenes satelitales o sensores remotos.
* Analizar y resolver redes de tránsito mediante la utilización de la extensión Network Analyst de ArcGIS.
* Obtener habilidades en programación utilizando el lenguaje Python y constructor de modelos de geo-procesamiento.
...
| Alcance                                                   | %  | Descripción                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
|:----------------------------------------------------------|:--:|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [Autopresentación](https://forms.office.com/r/idwtji0pTs) | 0  | El diligenciamiento de este formulario me permite conocer su perfil académico y profesional, carga académica y su nivel actual de conocimiento y habilidad                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| Asistencia                                                | 10 | La asistencia a clase es calificable. _🔥Las pruebas técnicas solo son válidos si asiste presencialmente a los talleres en el horario regular de clase_</br></br>**Pregrado**: acorde con el parágrafo del Artículo 38 del reglamento estudiantil, _“La asistencia a talleres y laboratorios es de carácter obligatorio. La inasistencia a estas actividades se califica con cero coma cero (0,0)”_</br></br>**Posgrado**: acorde con el Literal b del Artículo 46 del reglamento estudiantil, los estudiantes de posgrado deben _“Asistir y participar cumplida y activamente en todas las actividades académicas contempladas en el plan de estudios”_                                 |
| Quices                                                    | 40 | **Habilidad**: la presentación individual de los quices de habilidad es obligatoria. Requiere de informe técnico detallado<br/><br/>**Conocimiento**: la presentación de los quices de conocimiento es opcional y no calificable. Se recomienda realizar la lectura de las guías de clase y responder los quices de conocimiento antes del inicio de cada taller y como preparatorio para el componente conceptual evaluado en los examenes                                                                                                                                                                                                                                              |
| Exámenes                                                  | 50 | **Pregrado (examen por tercio)**: la presentación individual del examen por tercio es obligatoria. Se evalúan conocimientos y habilidades. Requiere de informe técnico detallado<br/><br/>**Posgrado (examen final)**: sí el promedio de calificaciones de todo el semestre es ≥ a 4.5 y su asistencia a clases es ≥ al 90%, estudiantes de posgrado no presenta examen final. Se evalúan conocimientos y habilidades. Requiere de informe técnico detallado                                                                                                                                                                                                                             |

> 🥇**Micro-certificación PYAS**: se obtiene si el promedio de calificaciones durante el semestre es superior o igual 4.5 (es obligatoria la presentación de exámenes por tercio).
> 
...
| [Quiz 0. Conocimiento](https://forms.gle/suVLbYJvhQX9SKa57)                         | Quiz de conocimiento con cálculos básicos de la forma de la tierra                                                                                                                                                                                                                                                                                       |
...
| Actividad                                                                 | Descripción                                                                                                                                                                   |
|:--------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [Documento guía](activity/TSIG_Taller8.pdf)                               | Guía de mapas cartográficos, plantillas y mapas distribuibles. [Documentación oficial QGIS](https://docs.qgis.org/3.44/en/docs/user_manual/print_layout/overview_layout.html) |
...
| [:sun_with_face: Iniciar curso](activity/M01A00/Readme.md) | [:infinity: Otros cursos y herramientas](https://github.com/rcfdtools) | [:beginner: Ayuda / Colabora](https://github.com/rcfdtools/R.TSIG/discussions/1) | [:notebook: Referencias](file/ref/Readme.md) | [:label: Dictionary](https://github.com/rcfdtools/rcfdtools/blob/main/file/ref/Dictionary.md) | <div align="center"><img alt="rcfdtools" src="file/graph/R.TSIG.svg" height="32px"></div> |
|-------------------------------------------------------------|------------------------------------------------------------------------|----------------------------------------------------------------------------------|----------------------------------------------|-----------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------|
