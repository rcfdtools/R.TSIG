...
| B     | Long Integer | Número de páneles: `B = Entero(AreaUsable / ((AnchoPanelenmilimetros * AltoPanelenmilimetros) / (1000 * 1000)))`. Tamaño de cada panel: 1950 x 992 milímetros. QGIS: `floor("A"/((1950*992)/(1000*1000)))`. :pencil2: Investigar y justificar el tamaño de cada panel, incluir referencias. |
| C     | Real (10)    | Potencial de Kilovatios producidos por hora (Kwh): `C = B * Potencia Panel / 1000`. Potencia por panel: 330 watts-hora. :pencil2: Investigar y justificar la potencia por panel, incluir referencias.                                                                                                            |
| D     | Real (10)    | Real de Kilovatios producidos por hora (Kwh): `D = C / Factor Pérdida`.  Factor de Perdida: 1.43. :pencil2: Investigar y justificar el factor de pérdida, incluir referencias.                                                                                                                                   |
...
| F     | Real (10)    | Potencial de Kilovatios producidos por dia para las horas de sol efectivas (Kwh - dia): `F = C * HorasEfectivasSolDia`.  Horas efectivas de sol al día: 5 hr/día. :pencil2: Investigar y justificar el número de horas efectivas de sol en Bogotá D.C., incluir referencias                                      |
