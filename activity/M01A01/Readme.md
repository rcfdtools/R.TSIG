# Fundamentos generales de herramientas SIG
Keywords: `realigment`  `m01a01`

xxxxxxxxxxxxxxxxxxxxxxxxxx

<div align="center"><img src="graph/M01A00.jpg" alt="R.TSIG" width="60%" border="0" /></div>

<div align="center"><img src="graph/Gravity_anomalies_on_Earth.jpg" alt="R.TSIG" width="60%" border="0" /><sub><br>Tomado de: <a href="Public Domain, https://commons.wikimedia.org/w/index.php?curid=479365">https://commons.wikimedia.org</a></sub><br><br></div>
...
* Establece el sistema de proyección de coordenadas en un mapa geográfico.
* Proyecta al vuelo capas geográficas desde diferentes sistemas de proyección.
* Crea rótulos dinámicos básicos y avanzados.
* Representa capas vectoriales por múltiples métodos de visualización.
* Crea filtros básicos y avanzados a partir de los atributos contenidos en una capa.
* Crea gráficos de una o múltiples variables y matrices de dispersión dinámicas para evaluar datos atípicos.
...
| [:arrow_backward: Anterior](../M01A00/Readme.md) | [:house: Inicio](../../README.md) | [:beginner: Ayuda / Colabora](https://github.com/rcfdtools/R.TSIG/discussions/1) | [Siguiente :arrow_forward:](../M01A02/Readme.md) |
|--------------------------------------------------|-----------------------------------|----------------------------------------------------------------------------------|--------------------------------------------------|
